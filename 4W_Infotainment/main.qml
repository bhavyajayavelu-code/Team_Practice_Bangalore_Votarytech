    ...
    Component {
        ...
        Rectangle {
            ...
            Column {
                    ...
                    Column {
                        ...
                        Rectangle {
                            ...
                            TextInput {
                                ...
                                onTextChanged: {
                                    CallManager.vehicleId = text
                                }
                            }
                        }

                        Text {
                            text: "Enter your vehicle identifier"
                            color: "#666666"
                            font.pixelSize: 10
                            anchors.horizontalCenter: parent.horizontalCenter
                        }
                ...
                // Fixed Emergency Number Section
                Rectangle {
                    width: parent.width
                    height: 80
                    color: "#1A1A1A"
                    ...
                    Column {
                        ...
                        Text {
                            text: "Fixed emergency number (24/7)"
                            color: "#888888"
                            font.pixelSize: 10
                            anchors.horizontalCenter: parent.horizontalCenter
                        }
                ...
                // Fixed Location Section (Whitefield, Bangalore)
                Rectangle {
                    width: parent.width
                    height: 100
                    color: "#1A1A1A"
                    ...
                    Column {
                        ...
                        Text {
                            text: "Coordinates will be sent via SMS"
                            color: "#888888"
                            font.pixelSize: 10
                            anchors.horizontalCenter: parent.horizontalCenter
                        }
                ...
                Button {
                    ...
                    background: Rectangle {
                        color: emergencyButton.enabled ?
                              (emergencyButton.pressed ? "#8B0000" : "#FF0000") :
                              "#666666"
                        radius: 30
                        border.color: "#FFFFFF"
                        border.width: 3
                        ...
                        SequentialAnimation on color {
                            running: emergencyButton.enabled && !emergencyButton.pressed
                            loops: Animation.Infinite
                    ...
                    contentItem: Column {
                        ...
                        Text {
                            text: "Call 9322403981 • SMS with Location"
                            color: "#FFFF00"
                            font.pixelSize: 14
                            font.bold: true
                            horizontalAlignment: Text.AlignHCenter
                        ...
                        Text {
                            text: "Whitefield, Bangalore (12.984593,77.7337515)"
                            color: "#FFFFFF"
                            font.pixelSize: 12
                            horizontalAlignment: Text.AlignHCenter
                            width: emergencyButton.width
                    ...
                    onClicked: {
                        ...
                        statusText.text = "🚨 EMERGENCY ACTIVATED"
                        statusDetail.text = "Calling 9322403981 and sending SMS with location..."
                        statusColorBar.color = "#FFA500"
                    }
                }
                ...
                Rectangle {
                    ...
                    color: "#1A1A1A"
                    radius: 10
                    border.color: statusColorBar.color
                    border.width: 2
                    ...
                    Column {
                        ...
                        Text {
                            id: statusDetail
                            text: "Press the red button for immediate assistance"
                            color: "#888888"
                            font.pixelSize: 12
                            horizontalAlignment: Text.AlignHCenter
                            width: parent.width
                ...
                // Info Text
                Text {
                    text: "⚠️ Emergency call and SMS will be sent to 9322403981\nYour vehicle ID will be included in the SMS"
                    color: "#666666"
                    font.pixelSize: 11
                    horizontalAlignment: Text.AlignHCenter
                    width: parent.width
            ...
            // Connections to CallManager signals
            Connections {
                target: CallManager

                function onEmergencyTriggered(number, location) {
                    console.log("✅ Emergency triggered for:", number, "at:", location)
                    statusText.text = "✅ EMERGENCY SUCCESSFUL"
                    statusDetail.text = "Call and SMS sent to " + number + "\nLocation: Whitefield, Bangalore"
                    statusColorBar.color = "#4CAF50"
                ...
                function onCallFailed(number, reason) {
                    ...
                    statusText.text = "❌ EMERGENCY FAILED"
                    statusDetail.text = "Error: " + reason + "\nPlease try again"
                    statusColorBar.color = "#FF0000"
                    emergencyButton.enabled = true
                }

                function onSmsSent(number, success) {
                    if (success) {
                        console.log("✅ SMS sent to:", number)
                    } else {
                        console.log("❌ SMS failed to:", number)
                    }
                }

                function onVehicleIdChanged(id) {
                    console.log("🚗 Vehicle ID updated to:", id)
                }
            }
            ...
            Timer {
                ...
                onTriggered: {
                    statusText.text = "Ready for emergency"
                    statusDetail.text = "Press the red button for immediate assistance"
                    statusColorBar.color = "#4CAF50"
                }
            }
            ...
            // Component loaded
            Component.onCompleted: {
                console.log("ECall View loaded - Fixed number: 9322403981")
                console.log("Fixed location: Whitefield, Bangalore (12.984593,77.7337515)")
                CallManager.vehicleId = vehicleIdInput.text
            }

            // Keyboard shortcut for emergency (Spacebar)
            Keys.onSpacePressed: {
                if (emergencyButton.enabled) {
                    emergencyButton.clicked()
                }
            }
